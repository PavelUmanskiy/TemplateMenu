...
Тэг работает рекурсивно, на экран выводятся только релевантные пункты меню (тольк url-путь и следующие страницы). На каждый тэе меню нужен только один запрос к базе данных.
